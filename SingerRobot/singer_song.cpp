    ...
    case HOUND_DOG:
      {
        ...
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, E03S, initialChord, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, initialChord, 7, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, initialChord, 1, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, G03S, initialChord, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, initialChord, 9, hasOutput);

        // Pattern 1: C
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, C03S, patternC, 1, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternC, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, C03S, patternC, 9, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternC, 12, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, E03S, patternC, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternC, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, E03S, patternC, 12, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternC, 15, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, G03S, patternC, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternC, 9, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, G03S, patternC, 15, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternC, 1, hasOutput);


        // Pattern 2: F
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, F03S, patternF, 1, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternF, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, F03S, patternF, 9, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternF, 12, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, A03S, patternF, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternF, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, A03S, patternF, 12, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternF, 15, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, C04S, patternF, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternF, 9, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, C04S, patternF, 15, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternF, 1, hasOutput);

        // Pattern 3: G
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, G03S, patternG, 1, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternG, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, F03S, patternG, 9, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternG, 12, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, B03S, patternG, 4, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternG, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, A03S, patternG, 12, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternG, 15, hasOutput);

        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, D04S, patternG, 7, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternG, 9, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, C04S, patternG, 15, hasOutput);
        setSemiquaverHit(AUTOMATIC_SINGER, POS_SG, OFFS, patternG, 1, hasOutput);
