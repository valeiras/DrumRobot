...
RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::RoboSong(){
      ...
      maxVel_ = pow(2, BITS_PER_BYTE - (BITS_FOR_HIT + BITS_FOR_POS)) - 1;
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::initializeBlankPatterns(unsigned int nbPatterns, unsigned int nbBeats) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::computeNextHit(byte limb, bool printOutput = false) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
unsigned long RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::getTimeNextHit(byte limb) {
  return timeNextHit_[limb];
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
byte RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::getPosNextHit(byte limb) {
  byte sequenceIndex = sequenceIndexes_[limb];
  byte patternId = patternSequence_[sequenceIndex];
  byte* currPattern = patternArrays_[limb][patternId];
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
byte RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::getVelNextHit(byte limb) {
  byte sequenceIndex = sequenceIndexes_[limb];
  byte patternId = patternSequence_[sequenceIndex];
  byte* currPattern = patternArrays_[limb][patternId];
  unsigned char hitIndex = hitIndexes_[limb];
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setBpm(unsigned short bpm) {
  bpm_ = bpm;
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setInitialTime(unsigned long initialTime) {
  for (unsigned int ii = 0; ii < NB_LIMBS; ii++) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setQuarterHit(byte limb, byte pos, byte velocity, byte patternId, byte noteIndex, bool printOutput) {
  byte semiquaversPerQuarter = 4;
  setHit(limb, pos, velocity, patternId, noteIndex, semiquaversPerQuarter, printOutput);
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setQuaverHit(byte limb, byte pos, byte velocity, byte patternId, byte noteIndex, bool printOutput) {
  byte semiquaversPerQuaver = 2;
  setHit(limb, pos, velocity, patternId, noteIndex, semiquaversPerQuaver, printOutput);
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setSemiquaverHit(byte limb, byte pos, byte velocity, byte patternId, byte noteIndex, bool printOutput) {
  byte semiquaversPerSemiquaver = 1;
  setHit(limb, pos, velocity, patternId, noteIndex, semiquaversPerSemiquaver, printOutput);
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setHit(byte limb, byte pos, byte vel, byte patternId, byte noteIndex, byte semiquaversPerNote, bool printOutput) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setQuarterRest(byte limb, byte patternId, byte noteIndex) {
  byte semiquaversPerQuarter = 4;
  setRest(limb, patternId, noteIndex, semiquaversPerQuarter);
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setQuaverRest(byte limb, byte patternId, byte noteIndex) {
  byte semiquaversPerQuaver = 2;
  setRest(limb, patternId, noteIndex, semiquaversPerQuaver);
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setSemiquaverRest(byte limb, byte patternId, byte noteIndex) {
  byte semiquaversPerSemiquaver = 1;
  setRest(limb, patternId, noteIndex, semiquaversPerSemiquaver);
}

template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setRest(byte limb, byte patternId, byte noteIndex, byte semiquaversPerNote) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setHitPattern(byte limb, byte patternId, byte p1, byte p2, byte p3, byte p4, byte p5, byte p6, byte p7,
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setVelPattern(byte limb, byte patternId, byte v1, byte v2, byte v3, byte v4, byte v5, byte v6, byte v7, byte v8, byte v9, byte v10, byte v11, byte v12, byte v13, byte v14, byte v15, byte v16, bool printOutput = false) {
  unsigned int nbPos = nbOfPositions_[limb];
  byte* currPattern = patternArrays_[limb][patternId];
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::setPatternSequence(byte pattSeq[]) {
  for (int ii = 0; ii < nbBeats_; ii++) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::printPatterns() {
  for (unsigned int ii = 0; ii < NB_LIMBS; ii++) {
    printPatterns(ii);
  }
}
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::printPatterns(byte limb) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::printHitPattern(byte limb, byte patternId) {
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::printPosPattern(byte limb, byte patternId) {
  if (limb < NB_LIMBS && patternId < nbPatterns_) {
    Serial.println("");
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
void RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::printVelPattern(byte limb, byte patternId) {
  if (limb < NB_LIMBS && patternId < nbPatterns_) {
    Serial.println("");
...
template <int NB_LIMBS, int BITS_FOR_HIT, int BITS_FOR_POS>
unsigned long RoboSong<NB_LIMBS, BITS_FOR_HIT, BITS_FOR_POS>::getMaxTimeToNextHit(){
